<section class="blog">
  <div class="container">
    ...
    <h2 class="section-title explore-title">
      Исследовательский центр Aliance production
    </h2>
    <div class="explore-content">
      <p class="explore-text">Явные признаки победы институционализации рассмотрены исключительно в разрезе
        ...
        Лишь акционеры крупнейших компаний могут быть призваны к ответу.</p>
      <p class="explore-text">С учётом сложившейся международной обстановки, синтетическое тестирование требует
        ...
        разбавленное изрядной долей эмпатии, рациональное мышление однозначно фиксирует необходимость стандартных
        подходов.</p>
    </div>
    ...
    <div class="swiper-container blog-slider">
      ...
      <div class="swiper-wrapper">
        ...
        <a href="#" class="swiper-slide blog-card explore-card">
          <picture class="blog-card-image">
            ...
            <img src="img/blog/2.jpg" alt="founder">
          </picture>
        </a>
        <a href="#" class="swiper-slide blog-card explore-card">
          <picture class="blog-card-image">
      ...
      <div class="blog-slider-footer explore-footer">
