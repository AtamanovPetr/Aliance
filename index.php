...
<html lang="en">
  ...
  <body class="front-page">
    ...
    <section class="section section-light map">
      <div class="container">
        <div class="seporator section-seporator"></div>
    ...
    <section class="section trademark">
      <div class="container">
        <div class="seporator"></div>
        <h2 class="section-title trademark-title">собственные марки</h2>
        ...
        <div class="clients-wrapper">
          <div class="clients-content">
            ...
            <ul class="clients-list">
              ...
              <li class="clients-list-item">
                <svg width="30" height="30" class="client-list-icon">
                  <use href="img/sprite.svg#build"></use>
                </svg>
