<section class="cta">
  <div class="bg-grey section-cta">
    <picture class="cta-image">
      ...
      <img src="img/cta.png" alt="founder">
    </picture>
      ...
      <form action="handler.php" class="cta-form js-form" method='POST'>
        ...
        <div class="input-group-wrapper">
          <div class="input-group">
            <input id="username" type="text" class="input" name="username" placeholder=" " maxlength='100' required />
            <label class="input-group-label" for="username">Имя</label>
          </div>
          <div class="input-group">
            <input id="userphone" type="tel" class="input" name="userphone" placeholder=" " maxlength='30' required />
            <label class="input-group-label" for="userphone">Номер телефона</label>
          </div>
        </div>
    ...
    <form action="handler.php" class="modal-form js-form" method="POST">
      <div class="input-group-wrapper input-group-vertical">
        <div class="input-group modal-input-group">
          <input id="modal-username" type="text" class="input modal-input" placeholder=" " name="username" />
          <label class="input-group-label modal-input-label" for="modal-username">Имя</label>
        </div>
        <div class="input-group modal-input-group">
          <input id="modal-userphone" type="tel" class="input modal-input" placeholder=" " name="userphone" />
          <label class="input-group-label modal-input-label" for="modal-userphone">Номер телефона</label>
        </div>
      </div>
